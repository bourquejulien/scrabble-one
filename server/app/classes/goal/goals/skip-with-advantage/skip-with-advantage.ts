...
export class SkipWithAdvantage extends BaseGoal implements SkipNotifier, StatsNotifier {
        ...
        super(
            {
                ...
                name: "Passer son tour en ayant plus de points que l'adversaire et encore être en avance au prochain tour",
                score: 15,
            },
            ownerId,
        );
    ...
    notifyStats(stats: PlayerStats, id: string): void {
        ...
        if (this.successId !== '' || !this.isEligible.has(id) || !this.isInAdvance(id)) {
            this.isEligible.delete(id);
            return;
        }
